 ...
 * en la hoja de datos del equipo. Observe que los elementos "reservedx" también están presentes alli.
 */
typedef struct
{
	...
	volatile uint32_t AHB2ENR;		//AHB1 peripheral clock enable Register		ADDR_OFFSET:	0x34
	...
	volatile uint32_t APB2ENR;		//APB1 peripheral clock enable Register		ADDR_OFFSET:	0x44
 ...
 * No son necesario en este ejercicio:
 * 6.3.1
 * 6.3.2
 * 6.3.3
 * 6.3.4
...
/*==== FIN de la descrición de los elementos que componen el periférico RCC ======*/
 ...
 * de cada uno de los registros que componen dicho periférico, pero si es necesario comprender que
 ...
 * PIN (1 o 8). Este registro puede ser escrito y leido desde el software, pero no garantiza
