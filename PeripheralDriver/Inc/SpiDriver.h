...
typedef struct
{
	uint8_t SPI_mode;			// Define los 4 diferentes modos que se puede configurar
	uint8_t SPI_baudrate;		// DEfine la velocidad que maneja el SPI con respecto
	uint8_t SPI_fullDupplexEnable;	// Configura si solo recepcion o bi-direccional
